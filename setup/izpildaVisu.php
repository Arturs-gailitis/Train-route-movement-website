...
<body>
        ...
        <div id="opcijuLaukums">
            ...
            <div class="fonaIzmaiņas" id="valodaIzmaiņas">
                ...
                <select name="valoda" id="valoda">
                    <option value="http://localhost:8000/setup/izpildaVisu.php">Latviešu</option>
                    <option value="http://localhost:8000/setup/runAll.php">Angļu</option>
                </select>
            </div>
    ...
    <div id="laukums">
        <h2>Tabulas ir izveidotas veiksmīgi</h2>
